            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="review-add">
                        <h4>Add Review</h4>
                        <form action="{{ url('reviews/'.$review->id) }}" method="post" class="ra-form">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group row">
                                        ...
                                        <select class="form-control col-lg-3" required id="rating" name="rating">
                                            <option value="{{ $review->rating }}"> 
                                                ...
                                                @elseif($review->rating == 3) OK
                                                @elseif($review->rating == 2) Poor
                                                @elseif($review->rating == 1) Very Bad
                                                @endif
                                            </option>
                                    ...
                                    <div class="form-group">
                                        <textarea placeholder="Your Review"  name="review">{{ $review->review }}</textarea> 
                                    </div>
